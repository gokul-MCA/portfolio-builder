    ...
    <footer className="bg-primary">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-4 rounded-lg bg-dominant p-6 shadow-lg sm:flex-row sm:justify-between">
          ...
          <GetStarted>
            <a
              className="inline-flex items-center gap-2 rounded-full border border-[#081C15] bg-white px-8 py-3 text-black 
          hover:bg-primary focus:outline-none focus:ring active:border-dominant cursor-pointer text-sm font-medium"
            >
              Let&apos;s Get Started
              <svg
        ...
        <div className="mt-16">
          ...
          <div className="mt-16 sm:flex sm:items-center sm:justify-between">
            <p className="mt-4 text-center text-sm text-black sm:mt-0 sm:text-right">
