  ...
  return (
    <PageLayout>
      <section className="mt-16 ">
        <div className="flex flex-col items-center justify-center px-4 py-6 lg:py-10">
          {/* Welcome to Home */}
          <h1 className="head1 m-3 mt-4 lg:mt-10">
            Showcase Your Talent with Tailored Elegance
          </h1>
          <h2 className="head2 m-2 mt-3 md:mt-4 lg:mt-8">
          ...
          <div className="w-full max-w-4xl text-center px-4 py-4 md:py-10 md:px-20">
            ...
            <p className="text-xs md:text-sm lg:text-lg  mb-4 md:mb-8">
              <em className="">
            ...
            {/* 2 */}
            <p className="text-xs md:text-sm lg:text-lg  mt-6 md:mt-8 lg:mt-8 text-justify">
              Create a stunning portfolio that reflects your passion and skills.
              Our platform provides intuitive tools to help you design and build
              a personalized showcase of your work. Whether you’re a designer,
