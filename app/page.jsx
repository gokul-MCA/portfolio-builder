...
export default function Home() {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen px-4">
      ...
      <div className="w-4/6 text-center sm:text-lg m-4 px-6 py-10">
        {/* 1 */}
      ...
      <GetStarted
        ...
        hover:text-white focus:outline-none focus:ring active:bg-white/90 m-4"
      >
        Let&apos;s Get Started
      </GetStarted>
      <span className="pt-10">
        <svg
          ...
          className="animate-bounce cursor-pointer hover:rounded-full hover:border hover:bg-slate-300 hover:text-black p-1"
        >
          <path
